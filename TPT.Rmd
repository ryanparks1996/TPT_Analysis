...
#creating a single csv to be used for practice with SQL
write_csv(Average_TPT, "C:/Users/ryans/Documents/TPT Project/Copy of Average TPT.csv")
```
...
viz <- ggplot(data=Average_TPT_Cleaned, aes(x=`Site Code`, y=`Week 1`)) +
  ...
  geom_hline(aes(yintercept=3, linetype="3.0")) +
